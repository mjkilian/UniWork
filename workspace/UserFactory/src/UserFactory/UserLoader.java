...
public class UserLoader {
	...
	public static void usage(){
		System.out.printf("Please give at least one .csv file as an argument and rerun. These files " +
	...
	public static void main(String args[]){
		UserStoreImpl userstore = new UserStoreImpl("users.ser","students.ser","employers.ser","visitor.ser");
