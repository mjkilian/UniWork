...
import Calendar.Day.CalendarDate;
...
public class Appointment {
	...
	public EventTime start_time, end_time; // start time and end time for the appointment
	...
	public Appointment(String name, CalendarDate the_date, EventTime s_time, EventTime e_time, String desc){
		ap_id = 0;
	...
	public Appointment(String name, CalendarDate the_date, EventTime s_time, EventTime e_time, String desc, String loc){
		ap_id = 0;
	...
	public Appointment(String name,CalendarDate the_date, EventTime s_time, EventTime e_time, String desc, String loc, String cat){
		ap_id = 0;
	...
	public Appointment(String name, CalendarDate the_date, EventTime s_time, EventTime e_time, String desc, String loc, String cat, Recurrence rec, int rem){
		ap_id = 0;
