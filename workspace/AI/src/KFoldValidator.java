...
public class KFoldValidator {
	...
	/**
	 * K fold test. Performs an classification taking the test data from the specified fold. folds are numbered 0 - K-1
	 *
	 * @param noFolds the number of folds
	 * @param foldNo the fold number we are considering
	 * @return the percentage of classifications made correctly
	 */
